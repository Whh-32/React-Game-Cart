...
const Footer = () => {
    return (
        <footer className="text-center lg:text-left bg-[#141414] text-white mt-[20px] px-[20px]">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                <div className="mr-12 hidden lg:block">
                    <span>Get connected with us on social networks:</span>
                </div>
                <div className="flex justify-center">
                    <a href="#!" className="mr-6 text-white hover:text-[#FAD860]">
                    ...
                    <a href="#!" className="text-white hover:text-[#FAD860]">
            ...
            md:justify-start
          ">
                            <span className='w-[35px] h-[35px] mr-2 grayscale' >
            ...
            <div className="flex justify-center items-center p-6 bg-[#141414] h-[30px]">
                <span className='text-[14px]'>© 2021 Copyright whh32</span>
            </div>
        </footer>
    )
}
